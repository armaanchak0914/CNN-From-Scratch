...
//making this an abstract class for the purpose of keeping it customizable
public abstract class Layer {

    //keep track of next layer and previous layer
    ...
    //does all the calculations for this layer so it can be passed to the next
    public abstract double[] getOutput(List<double[][]> input);
    //to be called as a vector
